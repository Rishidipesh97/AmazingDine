      ...
      <div class='product-item'>
        ...
        <div class='product-info'>
          ...
          <span class='p-price-sale'>₹.$pro_price.00</span>
           <button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs' name=addToCart>AddToCart</button>
        </div>
      </div>
			...
			while ($row=mysqli_fetch_array($query)) {
				...
				echo '
					<div class="row">
						...
						<div class="col-md-3">
						<img class="img-responsive" src="admin_area/product_images/'.$product_image.'" style="width:60px; height:60px;" />
						</div>
